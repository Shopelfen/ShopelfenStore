                ...
                .then(result => {
                    if(result.type === "success"){
                        ...
                        for(let i = 0; i < data.length; i++){
                            if(data[i].version !== 'invalid'){
                                let plugin = {
                                    title: data[i].title,
                                    manufacturer: data[i].author,
                                    technicalName: data[i].technicalName,
                                    id: data[i].id,
                                    image: data[i].hasImage ? "https://my.shopelfen.de/extension-api/extension-image/" + data[i].id : testImage,
                                    active: data[i].active,
                                    validUntil : data[i].validUntil
                                }
