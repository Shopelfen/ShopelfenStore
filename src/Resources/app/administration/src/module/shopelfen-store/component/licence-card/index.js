...
/*
            try {
                ...
                let url = 'https://my.shopelfen.de/extension-api/receive-extension/' + this.storeNumber + "/" + this.extensionId;
                console.log("My url: " + url);

                const response = await fetch('https://my.shopelfen.de/extension-api/receive-extension/' + this.storeNumber + "/" + this.extensionId, {
                    method: 'POST',
                    headers: {
                ...
                if(!response.ok){
                    this.createNotificationError({
                        title: 'Error',
                        message: "Fehler beim Download der Extension: HTTP-Fehler! Status: " + response.status
                    });
                    return;
                }
                ...
                if(data.type === "success") {
                    ...
                    this.createNotificationSuccess({
                        ...
                        message: 'Der Download der Extension <strong>' + this.title + '</strong> wurde erfolgreich abgeschlossen. Klicken Sie auf "Installieren", um die Installation abzuschließen.'
                    });
                }else{
                    this.createNotificationError({
                        title: 'Error',
